...
\newcommand{\version}{Version: 1.4} %======================================================= DOC VERSION
...
\newcommand{\versionhistory}{
		\begin{tabularx}{\linewidth}{| p{2cm} | p{2cm} | p{2cm} | X | }
			...
			\hline
			CCN & 14/02/2014 & 1.5 & Removed broken document markup by Kieran \\
			\hline
		\end{tabularx}
}
...
\begin{section}{DEPENDENCY DESCRIPTION}
	\begin{subsection}{Class Diagrams - Inheritance Relationships}
		\begin{subsubsection}{Android Activity Classes}
			\includegraphics[angle=270,width=0.73\columnwidth]{../ClassDiagrams/InterfaceClasses.png}
		\end{subsubsection}
		
		\clearpage
		\begin{subsubsection}{Android Data Classes}
			\includegraphics[angle=270,width=0.8\columnwidth]{../ClassDiagrams/DataClasses.png}
		\end{subsubsection}
	\end{subsection}
\end{section}
...
\begin{section}{INTERFACE DESCRIPTION}
	\begin{subsection}{Android Activities}
		\begisn{subsubsection}{AbstractActivity \{abstract\}}
		...
		\begin{subsubsection}{GPSService}
			...
			caption=DataEntryActivity \{Abstract\}]{interfaces/GPSService.java}
		\end{subsubsection}
