...
\begin{document}
	...
	\clearpage
		...
		{\bf Acceptance:} I, Charlie, agree with the above statement. I made a large effort to restore any project time lost, and did so several times over. I feel, however, that my contribution to the the project was a little higher than my 'fair share', and that I had to pick up a lot of slack left by some of the less capable team members. With that said, I would do it again if it ensured the project reached successful completion. The comments on my attendance during ITW are fair, but reflect the extremely late nights I was working on the project - long after the day had officially ended.
