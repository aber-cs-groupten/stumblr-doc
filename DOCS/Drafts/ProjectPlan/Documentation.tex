		...
		\begin{subsection}{Android Interface Designs}
			...
			\begin{subsubsection}{Location Information}
				\begin{figure}[h!]
					...
					\end{center}
					\caption{The name and description can be entered into text boxes on this screen. Also images of the location can be added using the Add Image button. Images that have been added will be displayed below the Add Image button, and below the image placeholder is the Save button that will return the user to the Route Content screen.}
				\end{figure}
			\end{subsubsection}
