...
\begin{document}
	...
	\begin{section}{TEST TABLE}
		\begin{subsection}{Ongoing Tasks}
			\begin{tabularx}{\linewidth}{| p{0.7cm} | p{0.8cm} | p{2.75cm} | p{2.5cm} | X | X |}
				\hline
...
&
Description will be added and entered into databased.
&
No error messages displayed and description appears on database.
\\
\hline
...
\newpage
\begin{tabularx}{\linewidth}{| p{0.7cm} | p{0.8cm} | p{2.75cm} | p{3.5cm} | X | X |}
				\hline
10
&
FR 3
